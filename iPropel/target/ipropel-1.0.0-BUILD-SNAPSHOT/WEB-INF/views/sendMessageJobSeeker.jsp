              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a href="sendMessagePageMenu.htm">Send Message</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" >
      ...
      <section id="main-content">
		...
		<!-- BASIC FORM ELELEMNTS -->
          	<div class="row mt">
                  ...
                  <form class="form-horizontal style-form" method="post" action="sendMessageJobSeeker.htm">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">User Email</label>
                              <div class="col-sm-10">
                                  <input class="form-control" type="email" name="replyEmail" data-ng-model="replyEmail" value="${param.replyEmail}">
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <textarea class="form-control" placeholder="Message" name="userMessageFromJobSeeker" data-ng-model="userMessageFromJobSeeker"></textarea>
                              </div>
                          </div> 
