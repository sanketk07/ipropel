              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">         
                         ...
                         <li class="active"><a href="uploadProfilePicture.htm">Upload Profile Picture</a></li>               
                      </ul>
                  </li>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Upload Profile Picture</h3>
		...
		<!-- BASIC FORM ELELEMNTS -->
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                  	  ...
                  	  <form:form commandName="jobSeekerModel" method="post" enctype="multipart/form-data" action="${contextPath}/uploadProfilePic.htm">
                      <%-- <form class="form-horizontal style-form" method="post" action="uploadResume.htm"> --%>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Upload Profile Picture</label>
                              <div class="col-sm-10">
                                 <!--  <input class="form-control" id="disabledInput" type="file"> -->
                                 <form:input type="file" name="photo" path="profilePhoto" />
                              </div>
                          </div>
