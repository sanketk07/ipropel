              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">    
                          ...
                          <li class="active"><a  href="viewAllJobs.htm">Available Jobs</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;">
      ...
      <!--main content start-->
       <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> AVAILABLE JOBS</h3>
          	<hr>
				<div class="row mt">
					<c:forEach items="${jobsList}" var="availableJob">
                      	<div class="col-md-4 col-sm-4 mb">
                      		<div class="white-panel pn donut-chart">
                      		  	<div class="row">
                      		  	
						           <div class="col-sm-6 col-xs-6 goleft">
								        <p>${availableJob.jobTitle}</p>
								        <p>${availableJob.jobDescription}</p>
								        <p>${availableJob.jobLocation}</p>
								        <p>${availableJob.jobSalary}</p>
								        <p>${availableJob.jobPostedOn}</p>
								        <p>${availableJob.jobExpiresOn}<p> 
						           </div>
						           <form action="applyJob.htm" method="post">
							           	<input type="hidden" name="applliedJobId" value="${availableJob.jobId}"/>
							           	<input type="submit" class="btn btn-theme" value="APPLY"/>
						           </form>
