              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">         
                         ...
                         <li class="active"><a href="editProfile.htm">Edit Profile</a></li>  
		...
		<!-- BASIC FORM ELELEMNTS -->
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" method="post" action="updateSeekerProfile.htm">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Name</label>
                              <div class="col-sm-10">
                                  <input class="form-control" id="disabledInput" type="text" placeholder="Firstname Lastname" readonly>
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input value="email@example.com" type="email" class="form-control">
                                  <span class="help-block">Enter an email of the format email@example.com</span>
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input value="1234567890" type="text" class="form-control">
                                  <span class="help-block">Enter a phone number 10 digits long and without the country code.</span>
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" value="myusername"  class="form-control" placeholder="Enter new username">
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Password</label>
                              <div class="col-sm-10">
                                  <input type="password" value="mypassword" class="form-control" placeholder="Enter new password">
                              </div>
                          </div>
