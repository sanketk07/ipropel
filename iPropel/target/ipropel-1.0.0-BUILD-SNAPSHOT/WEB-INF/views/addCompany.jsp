      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      <a href="addCompany.htm" class="active">
                  ...
                  <li class="sub-menu">
                      <a href="viewJobSeekers.htm">
                          <i class="fa fa-cogs"></i>
                          <span>View Job Seekers</span>
                      </a>
                  </li>
                   <li class="sub-menu">
                      <a href="viewRecruiters.htm" >
                  ...
                  <li class="sub-menu"><a href="javascript:;">
						...
						<ul class="sub">
							...
							<li><a href="sendMessageAdmin.htm">Send Message</a></li>
						</ul>
				</li>
                  <li class="sub-menu">
                      <a href="javascript:;" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Create Company</h3>
		...
		<!-- BASIC FORM ELELEMNTS -->
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" method="post" action="createNewCompany.htm">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Company Name</label>
                              <div class="col-sm-10">
                                  <input class="form-control" type="text" name="companyName" placeholder="Company Name" data-ng-model="companyName">
                              </div>
                          </div>
                          
                           <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Company Headquarters</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" placeholder="Company Name" data-ng-model="companyHq">
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" placeholder="Job Function" name="companyIndustry" data-ng-model="companyIndustry">
                                  
                              </div>
                          </div>    
                          
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">H1B Sponsorship Provided</label>
                              <div class="col-sm-10">
                                  <input type="radio" class="form-control" data-ng-model="h1b" value="yes">Yes
                                  <input type="radio" class="form-control" data-ng-model="h1b" value="no">No
                                                                    
                              </div>
                          </div>                                                  
                          
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Company Description</label>
                              <div class="col-sm-10">
                                  <textarea class="form-control" placeholder="Company Description" name="companyDescription" data-ng-model="companyDescription"></textarea>
                              </div>
                          </div> 
                          
                          <input type="submit" class="btn btn-theme" value="Create Company">
                      </form>
                  </div>
          		</div><!-- col-lg-12-->      	
          	</div><!-- /row -->
