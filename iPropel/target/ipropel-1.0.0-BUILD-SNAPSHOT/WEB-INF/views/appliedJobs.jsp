          ...
          <div id="sidebar"  class="nav-collapse">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">    
						  <li  class="active"><a  href="viewAppliedJobs.htm">My Jobs</a></li>                      	                        
      ...
      <!--main content start-->
       <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> APPLIED JOBS</h3>
          	<hr>
				<div class="row mt">
					<c:forEach items="${appliedJobsList}" var="appliedJob">
                      	<div class="col-md-4 col-sm-4 mb">
                      		<div class="white-panel pn donut-chart">
                      		  	<div class="row">
                      		  	
						           <div class="col-sm-6 col-xs-6 goleft">
								        <p>${appliedJob.jobTitle}</p>
								        <p>${appliedJob.jobDescription}</p>
								        <p>${appliedJob.jobLocation}</p>
								        <p>${appliedJob.jobSalary}</p>
								        <p>${appliedJob.jobPostedOn}</p>
								        <p>${appliedJob.jobExpiresOn}<p> 
								        
								        <!-- Have to add application date too -->
						           </div>
