              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">    
                          ...
                          <li><a  href="createNewJob.htm">Create New Job</a></li>
                      </ul>
                  </li>
                   <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a  href="generateResumePage.htm">View Applicants by Skills</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" >
						...
						<div class="project-wrapper">
		                    <div class="project">
		                        <div class="photo-wrapper">
		                            <div class="photo">
		                            	<a class="fancybox" href="<c:url value="resources/img/portfolio/port04.jpg" />"><img class="img-responsive" src="<c:url value="resources/img/portfolio/port04.jpg" />" alt=""></a>
		                            </div>
					...
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 desc">
						<div class="project-wrapper">
		                    <div class="project">
		                        <div class="photo-wrapper">
		                            <div class="photo">
		                            	<a class="fancybox" href="<c:url value="resources/img/portfolio/port05.jpg" />"><img class="img-responsive" src="<c:url value="resources/img/portfolio/port05.jpg" />" alt=""></a>
		                            </div>
		                            <div class="overlay"></div>
		                        </div>
		                    </div>
					...
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 desc">
						<div class="project-wrapper">
		                    <div class="project">
		                        <div class="photo-wrapper">
		                            <div class="photo">
		                            	<a class="fancybox" href="<c:url value="resources/img/portfolio/port06.jpg" />"><img class="img-responsive" src="<c:url value="resources/img/portfolio/port06.jpg" />" alt=""></a>
		                            </div>
		                            <div class="overlay"></div>
		                        </div>
		                    </div>
					...
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 desc">
						<div class="project-wrapper">
		                    <div class="project">
		                        <div class="photo-wrapper">
		                            <div class="photo">
		                            	<a class="fancybox" href="<c:url value="resources/img/portfolio/port01.jpg" />"><img class="img-responsive" src="<c:url value="resources/img/portfolio/port01.jpg" />" alt=""></a>
		                            </div>
		                            <div class="overlay"></div>
		                        </div>
		                    </div>
					...
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 desc">
						<div class="project-wrapper">
		                    <div class="project">
		                        <div class="photo-wrapper">
		                            <div class="photo">
		                            	<a class="fancybox" href="<c:url value="resources/img/portfolio/port02.jpg" />"><img class="img-responsive" src="<c:url value="resources/img/portfolio/port02.jpg" />" alt=""></a>
		                            </div>
		                            <div class="overlay"></div>
		                        </div>
		                    </div>
					...
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 desc">
						<div class="project-wrapper">
		                    <div class="project">
		                        <div class="photo-wrapper">
		                            <div class="photo">
		                            	<a class="fancybox" href="<c:url value="resources/img/portfolio/port03.jpg" />"><img class="img-responsive" src="<c:url value="resources/img/portfolio/port03.jpg" />" alt=""></a>
		                            </div>
		                            <div class="overlay"></div>
		                        </div>
		                    </div>
