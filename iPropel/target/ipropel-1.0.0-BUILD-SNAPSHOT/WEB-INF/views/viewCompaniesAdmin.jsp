  ...
  <section id="container" >
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      <a href="viewCompanies.htm" class="active">
                          <i class="fa fa-book"></i>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
       ...
       <div class="row mt">
                      <div class="text-center"><h1>REGISTERED COMPANIES</h1></div>
                      <a class="btn btn-theme" href="${contextPath}/adminreport.htm?output=pdf">GENERATE PDF REPORT</a>
                      <a class="btn btn-theme" href="${contextPath}/adminreport.htm?output=excel">GENERATE EXCEL REPORT</a>
                       <a class="btn btn-theme" href="${contextPath}/velocityView">VELOCITY VIEW</a>
