     ...
     <!--main content start-->
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> View Applicants by skills</h3>
          	
          	<div class="row mt">
          		<div class="col-lg-12">
          		<form class="form-horizontal style-form" method="post" action="viewApplicantsBySkill.htm">
          		 <div class="form-group">
                  	<label class="col-sm-2 col-sm-2 control-label">Choose skill</label>
                             <select class="form-control" data-ng-model="chooseSkillToViewApplicants">
						  				<option value="fullTime" selected>Jobs</option>	<!-- Populate Skills from db -->			  									 
							</select>
						</div>
						 <div class="form-group">
