...
app.controller('ipropelController', function($scope, $http){
	...
	$scope.fetchSkillList=function(){
		
		console.log('Inside fetchSkillList');
		$http.get("getSkills.htm")
	    .success(function(data) {
	    	console.log('response data from fetch skills: '+data);
