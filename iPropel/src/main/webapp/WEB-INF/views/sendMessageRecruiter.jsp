		...
		<section id="main-content">
			<section class="wrapper">
				...
				<div class="row mt">
					...
					<form class="form-horizontal style-form" method="post" action="messageFromRecruiter.htm">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <textarea class="form-control" placeholder="Message" name="userMessageFromRecruiter" data-ng-model="userMessageFromRecruiter"></textarea>
                              </div>
                          </div> 
