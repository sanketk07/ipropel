  ...
  <section id="container" >
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      <a href="viewJobSeekers.htm" class="active">
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
       ...
       <div class="row mt">
                      <div class="text-center"><h1>ACTIVE JOB SEEKERS</h1></div>
                      <!-- SERVER STATUS PANELS -->
                      	<c:forEach items="${model.activeJobSeekersList}" var="jobSeeker">
                      	<div class="col-md-4 col-sm-4 mb">
                      		<div class="white-panel pn donut-chart">
						           ...
						           <div class="col-sm-6 col-xs-6 goleft">
										        ...
										        <p>${jobSeeker.email}</p>
										        <p>${jobSeeker.phoneNo}</p>
										        <p>${jobSeeker.jobSeekerDesc}<p> 
										        <p>${jobSeeker.lastLogin}</p>
						           </div>
						           
						            <form action="messageJobSeeker.htm" method="post">
							           	<input type="hidden" name="recipientEmail" value="${jobSeeker.email}"/>
							           	<input type="submit" class="btn btn-theme" value="MESSAGE"/>
						           </form>
						           
						           <form action="deactivateJobSeeker.htm" method="post">
						           		<input type="hidden" name="recipientEmail" value="${jobSeeker.email}"/>
							           	<input type="submit" class="btn btn-theme" value="DEACTIVATE ACCOUNT"/>
						           </form>
					...
					<hr>
					 ...
					 <div class="row mt">
                      <div class="text-center"><h1>INACTIVE JOB SEEKERS</h1></div>
                      <!-- SERVER STATUS PANELS -->
                      	<c:forEach items="${model.inactiveJobSeekersList}" var="jobSeeker">
                      	<div class="col-md-4 col-sm-4 mb">
                      		<div class="white-panel pn donut-chart">
                      		  	<div class="row">
						           ...
						           <form action="activateJobSeeker.htm" method="post">
						           		<input type="hidden" name="recipientEmail" value="${jobSeeker.email}"/>
							           	<input type="submit" class="btn btn-theme" value="ACTIVATE ACCOUNT"/>
						           </form>
