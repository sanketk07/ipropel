              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a href="generateResumePage.htm">Generate Resume</a></li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a href="messageJobSeekerMenu.htm">Send Message</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i>Generate Resume from Profile</h3>
		...
		<!-- BASIC FORM ELELEMNTS -->
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                     ...
                     <%--  <form class="form-horizontal style-form" method="post" action="generateResume.htm"> --%>
                      <form class="form-horizontal style-form" method="post" action="adminreport.htm?output=pdf_resume">
                          ...
                          <input type="submit" class="btn btn-theme" value="Generate Resume">
                      </form>
                  </div>
          		</div><!-- col-lg-12-->      	
          	</div><!-- /row -->
