          ...
          <div id="sidebar"  class="nav-collapse">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	 ...
              	 <p class="centered">
              	 	<a>              	  
	              	 <c:choose>
					    <c:when test="${not empty sessionScope.jobSeekerPhoto}">
					   <%--  <c:when test="${not empty model.profilePicPath}"> --%>
					         <img src="<c:url value="${sessionScope.jobSeekerPhoto}" />" class="img-circle" width="60">
					         <%-- <img src="<c:url value="${model.profilePicPath}" />" class="img-circle" width="60"> --%>
					    </c:when>
					    <c:otherwise>
...
<%-- Photo path - ${sessionScope.jobSeekerPhoto} --%>
              <div class="row">
                  <div class="col-lg-9 main-chart">
                      ...
                      <c:choose>
					    <c:when test="${empty sessionScope.jobsList}">
