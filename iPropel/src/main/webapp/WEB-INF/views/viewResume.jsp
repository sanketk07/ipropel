              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a href="viewResume.htm">View Resume</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;">
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> View Resume</h3>
		...
		<!-- BASIC FORM ELELEMNTS -->
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                  	 ...
                  	 <iframe src="${resumeLink}" width="100%" height="800px;"></iframe>                
