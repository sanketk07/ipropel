     ...
     <!--main content start-->
       <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> APPLICANTS BY SKILL - ${model.skillName}</h3>
          	<hr>
				<div class="row mt">
                      <!-- <div class="text-center"><h1>ACTIVE JOB SEEKERS</h1></div> -->
                      <!-- SERVER STATUS PANELS -->
                      	<c:forEach items="${model.jobSeekersBySkillList}" var="jobSeeker">
                      	<div class="col-md-4 col-sm-4 mb">
                      		<div class="white-panel pn donut-chart">
                      		  	<div class="row">
                      		  	
						           <div class="col-sm-6 col-xs-6 goleft">
										        <p>${jobSeeker.firstName} ${jobSeeker.lastName}</p>
										        <p>${jobSeeker.email}</p>
						           ...
						           <form action="viewFullApplicantProfile.htm" method="post">
							           	<input type="hidden" name="applicantEmail" value="${jobSeeker.email}"/>
							           	<input type="submit" class="btn btn-theme" value="VIEW PROFILE"/>
						           </form>
