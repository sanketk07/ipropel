  ...
  <section id="container" >
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                   ...
                   <li class="sub-menu">
                      <a href="viewRecruiters.htm" class="active">
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
       ...
       <div class="row mt">
                      <div class="text-center"><h1>ACTIVE RECRUITERS</h1></div>
                      <!-- SERVER STATUS PANELS -->
                      	<c:forEach items="${recruitersList}" var="recruiter">
                      	<div class="col-md-4 col-sm-4 mb">
                      		<div class="white-panel pn donut-chart">
                      		  	<div class="row">
                      		  	
						           <div class="col-sm-6 col-xs-6 goleft">							            
										        <p>${recruiter.firstName}</p>
										        <p>${recruiter.lastName}</p>
										        <p>${recruiter.username}</p>
										        <p>${recruiter.email}</p>
										        <p>${recruiter.phoneNo}</p>	
										        <p>${recruiter.recruiterDesignation}</p>										        
						           </div>
						           
						           <form action="messageRecruiter.htm" method="post">
							           	<input type="hidden" name="applliedJobId" value="${recruiter.email}"/>
